...
using Gestion_Farmacia_martin.Services.Implementacion;
using AutoMapper;
using Gestion_Farmacia_martin.DTOs;
using Gestion_Farmacia_martin.Utilidades;
...
builder.Services.AddAutoMapper(typeof(AuyoMapperProfile ));
    ...
    IMapper _mapper) =>
{
    ...
    _encontrado.NombreCom = _empleado.NombreCom;
    _encontrado.IdDepartamento=_empleado.IdDepartamento;
    _encontrado.Sueldo= _empleado.Sueldo;
    _encontrado.FechaContratacion = _empleado.FechaContratacion;

    var respuesta = await _empleadoService.Update(_empleado);
